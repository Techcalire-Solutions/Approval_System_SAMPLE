...
var _StylesheetMap = class _StylesheetMap {
  constructor() {
...
_StylesheetMap.ɵprov = ɵɵdefineInjectable({
  token: _StylesheetMap,
  factory: _StylesheetMap.ɵfac,
  providedIn: "root"
});
var StylesheetMap = _StylesheetMap;
(() => {
...
var _StyleUtils = class _StyleUtils {
...
_StyleUtils.ɵfac = function StyleUtils_Factory(t) {
  return new (t || _StyleUtils)(ɵɵinject(StylesheetMap), ɵɵinject(SERVER_TOKEN), ɵɵinject(PLATFORM_ID), ɵɵinject(LAYOUT_CONFIG));
};
_StyleUtils.ɵprov = ɵɵdefineInjectable({
  token: _StyleUtils,
  factory: _StyleUtils.ɵfac,
  providedIn: "root"
});
var StyleUtils = _StyleUtils;
(() => {
...
var _MatchMedia = class _MatchMedia {
...
_MatchMedia.ɵfac = function MatchMedia_Factory(t) {
  return new (t || _MatchMedia)(ɵɵinject(NgZone), ɵɵinject(PLATFORM_ID), ɵɵinject(DOCUMENT), ɵɵinject(CSP_NONCE, 8));
};
_MatchMedia.ɵprov = ɵɵdefineInjectable({
  token: _MatchMedia,
  factory: _MatchMedia.ɵfac,
  providedIn: "root"
});
var MatchMedia = _MatchMedia;
(() => {
...
var _BreakPointRegistry = class _BreakPointRegistry {
  constructor(list) {
...
_BreakPointRegistry.ɵfac = function BreakPointRegistry_Factory(t) {
  return new (t || _BreakPointRegistry)(ɵɵinject(BREAKPOINTS));
};
_BreakPointRegistry.ɵprov = ɵɵdefineInjectable({
  token: _BreakPointRegistry,
  factory: _BreakPointRegistry.ɵfac,
  providedIn: "root"
});
var BreakPointRegistry = _BreakPointRegistry;
(() => {
...
var _PrintHook = class _PrintHook {
...
_PrintHook.ɵfac = function PrintHook_Factory(t) {
  return new (t || _PrintHook)(ɵɵinject(BreakPointRegistry), ɵɵinject(LAYOUT_CONFIG), ɵɵinject(DOCUMENT));
};
_PrintHook.ɵprov = ɵɵdefineInjectable({
  token: _PrintHook,
  factory: _PrintHook.ɵfac,
  providedIn: "root"
});
var PrintHook = _PrintHook;
(() => {
...
var _MediaMarshaller = class _MediaMarshaller {
  get activatedAlias() {
...
_MediaMarshaller.ɵfac = function MediaMarshaller_Factory(t) {
  return new (t || _MediaMarshaller)(ɵɵinject(MatchMedia), ɵɵinject(BreakPointRegistry), ɵɵinject(PrintHook));
};
_MediaMarshaller.ɵprov = ɵɵdefineInjectable({
  token: _MediaMarshaller,
  factory: _MediaMarshaller.ɵfac,
  providedIn: "root"
});
var MediaMarshaller = _MediaMarshaller;
(() => {
...
var _BaseDirective2 = class _BaseDirective2 {
...
_BaseDirective2.ɵfac = function BaseDirective2_Factory(t) {
  return new (t || _BaseDirective2)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(StyleBuilder), ɵɵdirectiveInject(StyleUtils), ɵɵdirectiveInject(MediaMarshaller));
};
_BaseDirective2.ɵdir = ɵɵdefineDirective({
  type: _BaseDirective2,
  features: [ɵɵNgOnChangesFeature]
});
var BaseDirective2 = _BaseDirective2;
(() => {
...
var _MockMatchMedia = class _MockMatchMedia extends MatchMedia {
...
_MockMatchMedia.ɵfac = function MockMatchMedia_Factory(t) {
  return new (t || _MockMatchMedia)(ɵɵinject(NgZone), ɵɵinject(PLATFORM_ID), ɵɵinject(DOCUMENT), ɵɵinject(BreakPointRegistry));
};
_MockMatchMedia.ɵprov = ɵɵdefineInjectable({
  token: _MockMatchMedia,
  factory: _MockMatchMedia.ɵfac
});
var MockMatchMedia = _MockMatchMedia;
(() => {
...
var _MediaObserver = class _MediaObserver {
...
_MediaObserver.ɵfac = function MediaObserver_Factory(t) {
  return new (t || _MediaObserver)(ɵɵinject(BreakPointRegistry), ɵɵinject(MatchMedia), ɵɵinject(PrintHook));
};
_MediaObserver.ɵprov = ɵɵdefineInjectable({
  token: _MediaObserver,
  factory: _MediaObserver.ɵfac,
  providedIn: "root"
});
var MediaObserver = _MediaObserver;
(() => {
...
var _MediaTrigger = class _MediaTrigger {
...
_MediaTrigger.ɵfac = function MediaTrigger_Factory(t) {
  return new (t || _MediaTrigger)(ɵɵinject(BreakPointRegistry), ɵɵinject(MatchMedia), ɵɵinject(LAYOUT_CONFIG), ɵɵinject(PLATFORM_ID), ɵɵinject(DOCUMENT));
};
_MediaTrigger.ɵprov = ɵɵdefineInjectable({
  token: _MediaTrigger,
  factory: _MediaTrigger.ɵfac,
  providedIn: "root"
});
var MediaTrigger = _MediaTrigger;
(() => {
...
@ngbracket/ngx-layout/fesm2022/ngbracket-ngx-layout-core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-BNC3O62K.js.map
